                        ...
                        <div class="cmp-tb-hd">
                            ...
                            <div class="form-example-int">
                                <div class="form-group">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control input-sm" value="{{ $student->firstName }}" name="firstName" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-example-int">
                                <div class="form-group">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control input-sm" value="{{ $student->lastName }}" name="lastName" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-example-int">
                                <div class="form-group">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="email" class="form-control input-sm" value="{{ $student->email }}" name="email" readonly>
                                    </div>
                                </div>
                            </div>
                            <div class="form-example-int mg-t-15">
                                <div class="form-group">
                                    <label>Bio</label>
                                    <div class="nk-int-st">
                                        <textarea name="bio" cols="100" rows="0" placeholder="Enter Bio" readonly>{{ $student->bio }}</textarea>
                                    </div>
                                </div>
                            </div>
                    </div>
